...
This is a multi-round structured interview. Use AskUserQuestion aggressively to nail down specifics. the user often speaks by voice — capture the essence, then confirm with structured questions. **Do NOT skip to HTML generation until every round is complete.**
