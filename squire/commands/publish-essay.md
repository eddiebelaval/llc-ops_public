# /publish-essay - Publish Essay to your-domain.app
...
2. **Create MDX File**
   - Location: `/Users/your-username/Development/id8labs-hub/core/content/essays/`
   - Filename: `{slug}.mdx`
   - Add/verify all required frontmatter fields

3. **Git Operations**
   ```bash
   cd /Users/your-username/Development/id8labs-hub
   git checkout main
...
5. **Return Essay URL**
   - Format: `https://your-domain.app/essays/{slug}`
...
author: "Your Name"          # Optional, defaults to the user
...
```
Publishing essay to your-domain.app...
...
Essay URL: https://your-domain.app/essays/the-70-percent-problem
