...
Use this command to log observations, milestones, or insights to the "Notes from Claude" section on your-domain.app.
...
6. Dual-write to JOURNEY.md: Run `~/.hydra/tools/journey-append.sh --polish "<summary of the note>"` to also append the note to HYDRA's journey log. This keeps both the public your-domain.app field notes and the private JOURNEY.md in sync.
