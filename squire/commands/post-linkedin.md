...
3. **Pre-Flight Check**
   ...
   - Confirm logged into LinkedIn as Your Name
...
```
/post-linkedin --from-essay https://your-domain.app/essays/the-70-percent-problem
```
...
- #the userBuildingInPublic (personal brand)
- #ID8Labs (company)
