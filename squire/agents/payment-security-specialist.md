...
**Your Solution**:
1. Create `/Users/your-username/Development/id8/id8composer-rebuild/src/lib/billing/validation.ts`
...
**Your Solution**:
1. Locate existing rate limiter in `/Users/your-username/Development/id8/id8composer-rebuild/src/lib/rate-limiting/` (or create if missing)
2. Apply to `/Users/your-username/Development/id8/id8composer-rebuild/src/app/api/billing/checkout/route.ts`:
   - Limit: 5 requests per minute per user
   - Return 429 with `Retry-After` header
3. Apply to `/Users/your-username/Development/id8/id8composer-rebuild/src/app/api/billing/portal/route.ts`:
   - Limit: 10 requests per minute per user

### Task 4: Integrate Validation into Endpoints
**Modify these files**:
- `/Users/your-username/Development/id8/id8composer-rebuild/src/app/api/billing/checkout/route.ts`
- `/Users/your-username/Development/id8/id8composer-rebuild/src/app/api/billing/portal/route.ts`
