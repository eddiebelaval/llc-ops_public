...
### Problem Analysis
**Current State**:
- Database migration `/Users/your-username/Development/id8/id8composer-rebuild/supabase/migrations/20251030_create_subscriptions_table.sql` line 23 uses "STUDIO" tier
...
**Create**: `/Users/your-username/Development/id8/id8composer-rebuild/supabase/migrations/20251110_fix_tier_naming.sql`
...
**Files to check**:
- `/Users/your-username/Development/id8/id8composer-rebuild/src/types/subscription.ts`
- `/Users/your-username/Development/id8/id8composer-rebuild/src/types/billing.ts`
- `/Users/your-username/Development/id8/id8composer-rebuild/src/lib/billing/plans.ts`
- All files in `/Users/your-username/Development/id8/id8composer-rebuild/src/lib/billing/`

**Action**: Replace all "STUDIO" with "ENTERPRISE"

#### Task 3: Verify RLS Policies Still Work
**Check**:
- `/Users/your-username/Development/id8/id8composer-rebuild/supabase/migrations/20251030_create_subscriptions_table.sql` lines 43-53
...
**Create**: `/Users/your-username/Development/id8/id8composer-rebuild/scripts/test-tier-migration.sql`
