...
The most complete Claude Code toolkit in the wild. Battle-tested behavioral rules, 63 slash commands, 328 skills, 34 custom agents, stage-gate pipelines, multi-model orchestration, and reusable thinking frameworks -- all derived from 2,990 sessions and 3,307 commits across 5 months of intensive AI-augmented development.
...
| [Skills](skills/) | 328 | Specialized skills across engineering, marketing, finance, AI/ML, design, and operations |
...
```bash
curl -fsSL https://raw.githubusercontent.com/your-username/squire/main/squire.md > squire.md
```

Or for global rules (all projects):

```bash
curl -fsSL https://raw.githubusercontent.com/your-username/squire/main/squire.md >> ~/.claude/CLAUDE.md
```
...
| Code Quality | 11 | code-reviewer, testing-qa, test-generator, git-workflow-designer, dslop |
...
This toolkit was built by [Your Name](https://x.com/your-usere) at [id8Labs](https://your-domain.app) while shipping 12+ AI-augmented products with Claude Code over 5 months. Every rule, pattern, and template came from real friction -- sessions where something went wrong, and the fix was documented so it wouldn't happen again.
...
**X:** [@your-handle](https://x.com/your-usere) | **GitHub:** [your-username](https://github.com/your-username) | **Site:** [your-domain.app](https://your-domain.app)
