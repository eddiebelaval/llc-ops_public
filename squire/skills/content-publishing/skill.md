...
description: Automated content publishing pipeline for ID8Labs. Generates essays in the user's voice, publishes to your-domain.app, and distributes to social media (X, LinkedIn).
category: marketing
complexity: complex
version: "1.0.0"
author: "ID8Labs"
...
Automated content publishing pipeline for ID8Labs that integrates with Pipeline Stage 10.5 (ANNOUNCE). This skill generates essays in the user's authentic voice, publishes them to your-domain.app, and distributes derived social content to X/Twitter and LinkedIn.
...
**Steps:**
1. Generate release essay in the user's voice
...
**Purpose:** Write compelling release announcement in the user's voice
...
author:
  name: "Your Name"
  avatar: "/images/the-user-avatar.jpg"
tags: ["tag1", "tag2"]
---
```
...
| `/write-release` | Generate release essay in the user's voice |
| `/write-research` | Generate research article in the user's voice |
...
Essays are published to `your-domain.app/essays/{slug}`:
...
- **Voice Consistency:** Always apply the user's voice profile for authenticity
...
|--------------|----------|
| Essays | `https://your-domain.app/essays/{slug}` |
...
- Logged into LinkedIn as Your Name
