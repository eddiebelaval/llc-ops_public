...
1. **NEVER skip the interview.** Do not fill in flow details from assumptions or inference. Every field comes from the user's answers.
...
- **DO NOT** approve your own flow specs — the user must sign off
